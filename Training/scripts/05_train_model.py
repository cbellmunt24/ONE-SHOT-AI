...
# Universal param bounds — same 88 params for ALL instruments (UniversalSynth layout)
UNIVERSAL_BOUNDS = [
    ("oscType",0,13), ("basePitch",20,12000), ("duration",0.01,5), ("masterGain",0,1),
    ("stereoWidth",0,1), ("pan",0,1), ("pitchEnvDepth",0,96), ("pitchEnvFast",0.0003,0.05),
    ("pitchEnvSlow",0.003,0.5), ("pitchEnvBalance",0,1), ("pitchHoldTime",0,0.03),
    ("pitchBounce",0,1), ("pitchWobble",0,1), ("wobbleRate",1,40),
    ("tonalLevel",0,1), ("bodyHarmonics",0,1), ("fmDepth",0,1), ("fmRatio",0.5,12),
    ("fmDecay",0.003,0.3), ("additiveAmt",0,1), ("harmonic2",0,1), ("harmonic3",0,1),
    ("harmonic4",0,1), ("harmonic5",0,1), ("inharmonicity",0,0.1), ("unisonVoices",0,1),
    ("unisonDetune",0.1,80), ("unisonDrift",0,1), ("phaseDistort",0,1),
    ("phaseDistDecay",0.003,0.2), ("subLevel",0,1), ("subDetune",-12,12),
    ("noiseLevel",0,1), ("noiseColor",0,1), ("noiseFilterFreq",100,16000),
    ("noiseFilterQ",0,1), ("noiseDecay",0.005,2), ("burstCount",1,8),
    ("burstSpacing",0.003,0.03), ("noiseAttack",0,0.02), ("residualAmt",0,1),
    ("residualLevel",0,1), ("noiseHP",20,2000), ("noiseStereo",0,1),
    ("noiseEvolution",0,1), ("granularDensity",0,1),
    ("modalLevel",0,1), ("modalMode",0,1), ("numModes",1,12), ("modeDecay",0.01,2),
    ("modeSpread",0,1), ("modeRatioBase",1,4), ("modeDamping",0,1),
    ("ksFeedback",0.9,0.999), ("ksDamping",0,1), ("ksBrightness",0,1),
    ("ksPickPosition",0,1), ("ksBodyResonance",0,1),
    ("transientLevel",0,1), ("clickType",0,3), ("clickFreq",500,14000),
    ("clickDecay",0.0001,0.015), ("clickWidth",0,1), ("snapAmount",0,1),
    ("transientSampleAmt",0,1), ("topNoise",0,1),
    ("ampAttack",0.0001,0.05), ("ampPunchDecay",0.005,0.5), ("ampBodyDecay",0.02,3),
    ("ampPunchLevel",0,1), ("envSustainLevel",0,1), ("envSustainTime",0,3),
    ("envRelease",0.005,5), ("envCurve",0.1,4),
    ("filterCutoff",100,20000), ("filterReso",0,0.95), ("filterSweepAmt",0,1),
    ("filterSweepStart",200,18000), ("filterSweepEnd",50,5000), ("formantAmt",0,1),
    ("formantFreq1",200,3500), ("formantFreq2",400,5000),
    ("reverbAmt",0,1), ("reverbDecay",0.03,2), ("chorusAmt",0,1),
    ("satAmount",0,1), ("satType",0,2), ("compAmount",0,1),
]

# Legacy per-instrument bounds — kept for backward compat with old optimized_params JSON
PARAM_BOUNDS = {inst: UNIVERSAL_BOUNDS for inst in
    ["kicks","snares","hihats","claps","percs","808s","leads","plucks","pads","textures"]}
